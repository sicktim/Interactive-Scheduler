 ...
 */
const STRUCTURE_CHANGEOVER_DATE = '2026-01-19';
...
const SHEET_STRUCTURES = {
  ...
  legacy: {
    ...
    roster: {
      // Multiple ranges for the roster structure
      ranges: [
  ...
  current: {
    sections: {
      supervision: { startRow: 1, endRow: 11, range: 'A1:N11' },
      flying: { startRow: 13, endRow: 134, range: 'A13:R94' },
      ground: { startRow: 136, endRow: 237, range: 'A96:M157' },
      na: { startRow: 239, endRow: 340, range: 'A159:K220' }
    },
    roster: {
      // Multiple ranges for the roster structure
      ranges: [
        { range: 'A228:D328', name: 'FTC-B', type: 'student', nameCol: 0 },
        { range: 'A329:D429', name: 'STC-B', type: 'student', nameCol: 0 },
        { range: 'E228:H328', name: 'FTC-A', type: 'student', nameCol: 0 },
        { range: 'E329:H429', name: 'STC-A', type: 'student', nameCol: 0 },
        { range: 'I228:L328', name: 'Staff IP', type: 'staff', nameCol: 0 },
        { range: 'I329:L429', name: 'Staff STC', type: 'staff', nameCol: 0 },
        { range: 'M228:P328', name: 'Staff IFTE/ICSO', type: 'staff', nameCol: 0 },
        { range: 'Q228:T328', name: 'Attached/Support', type: 'staff', nameCol: 0 },
        { range: 'M329:P429', name: 'Future Category 1', type: 'staff', nameCol: 0 },
        { range: 'Q329:T429', name: 'Future Category 2', type: 'staff', nameCol: 0 }
      ]
    }
  }
};
